...
public class Sound {
    ...
    public Sound(String strFile) {
        try {
            URL resURL = utils.UtilsForAll.getMainClass().getResource(strFile);
            AudioInputStream stream = AudioSystem.getAudioInputStream(resURL);
    ...
    */
    ...
    public static Sound playSoundFromResource(String s) {
