...
public class FrmCommand1 extends FrmCommand {
    private JTextArea textArea;

    public FrmCommand1(FrmContainerProgram mainContainer) {
        super(mainContainer, false);
        Border emptyBorder, lBorder, tBorder;

        jpMain = BoxLayoutUtils.createVerticalPanel();

        JPanel jpTAabout = new CreateLineBorderBox(0, 0, "Раздел Команд 1");
    ...
    public void setViewItemParam(MenuNode itemNode) {
        textArea.setText("Раздел Команд 1");
        jpMain.revalidate();
    }
