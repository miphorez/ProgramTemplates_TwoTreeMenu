...
public class FrmParam2 extends FrmParam {
    private JTextArea textArea;

    public FrmParam2(FrmContainerProgram mainContainer) {
        super(mainContainer, false);
        Border emptyBorder, lBorder, tBorder;

        jpMain = BoxLayoutUtils.createVerticalPanel();

        JPanel jpTAabout = new CreateLineBorderBox(0, 0, "Раздел Настроек 2");
    ...
    public void setViewItemParam(MenuNode itemNode) {
        textArea.setText("Раздел Настроек 2");
        jpMain.revalidate();
    }
